...
export default function ScanList({
  ...
  return (
    <div className="flex h-full flex-col bg-white transition-colors duration-300 dark:bg-slate-950">
      {/* 筛选面板和状态指示器 */}
            ...
            <table className="min-w-full border-collapse text-left">
              <thead className="sticky top-0 z-10 bg-slate-50 border-b border-slate-200 dark:bg-slate-900/95 dark:border-slate-800">
                <tr>
                  ...
                  <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-slate-500">
                    构建目录路径
                  </th>
                  <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wider text-slate-400 w-28 dark:text-slate-500">
                    归属生态
                  </th>
                  <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wider text-slate-400 text-right w-28">
                    占用空间
                  </th>
                  <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wider text-slate-400 text-right w-24">
                    文件总数
                  </th>
                  <th scope="col" className="px-4 py-3 text-xs font-semibold uppercase tracking-wider text-slate-400 w-44">
                    对应扫描规则
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 bg-white transition-colors duration-300 dark:divide-slate-800 dark:bg-slate-950">
                {entries.map((e) => {
                  ...
                  return (
                    <tr
                      key={e.id}
                      className={`group hover:bg-indigo-50/30 transition-colors cursor-pointer dark:hover:bg-indigo-900/10 ${
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5 text-right whitespace-nowrap font-mono text-xs text-slate-400 font-medium dark:text-slate-500">
